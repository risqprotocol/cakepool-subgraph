...
export class RisqAMZNPool__lockedLiquidityResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
...
export class RisqAMZNPool extends ethereum.SmartContract {
  static bind(address: Address): RisqAMZNPool {
    return new RisqAMZNPool("RisqAMZNPool", address);
  }
  ...
  lockedLiquidity(param0: BigInt): RisqAMZNPool__lockedLiquidityResult {
    let result = super.call(
      "lockedLiquidity",
    ...
    return new RisqAMZNPool__lockedLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBoolean()
    );
  ...
  try_lockedLiquidity(
    param0: BigInt
  ): ethereum.CallResult<RisqAMZNPool__lockedLiquidityResult> {
    let result = super.tryCall(
      "lockedLiquidity",
      "lockedLiquidity(uint256):(uint256,uint256,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new RisqAMZNPool__lockedLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBoolean()
      )

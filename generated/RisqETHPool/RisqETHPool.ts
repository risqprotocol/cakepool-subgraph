...
export class RisqETHPool__lockedLiquidityResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
...
export class RisqETHPool extends ethereum.SmartContract {
  static bind(address: Address): RisqETHPool {
    return new RisqETHPool("RisqETHPool", address);
  }
  ...
  lockedLiquidity(param0: BigInt): RisqETHPool__lockedLiquidityResult {
    let result = super.call(
      "lockedLiquidity",
    ...
    return new RisqETHPool__lockedLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBoolean()
    );
  ...
  try_lockedLiquidity(
    param0: BigInt
  ): ethereum.CallResult<RisqETHPool__lockedLiquidityResult> {
    let result = super.tryCall(
      "lockedLiquidity",
      "lockedLiquidity(uint256):(uint256,uint256,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new RisqETHPool__lockedLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBoolean()
      )

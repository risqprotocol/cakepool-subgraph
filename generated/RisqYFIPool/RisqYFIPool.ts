...
export class RisqYFIPool__lockedLiquidityResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
...
export class RisqYFIPool extends ethereum.SmartContract {
  static bind(address: Address): RisqYFIPool {
    return new RisqYFIPool("RisqYFIPool", address);
  }
  ...
  lockedLiquidity(param0: BigInt): RisqYFIPool__lockedLiquidityResult {
    let result = super.call(
      "lockedLiquidity",
    ...
    return new RisqYFIPool__lockedLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBoolean()
    );
  ...
  try_lockedLiquidity(
    param0: BigInt
  ): ethereum.CallResult<RisqYFIPool__lockedLiquidityResult> {
    let result = super.tryCall(
      "lockedLiquidity",
      "lockedLiquidity(uint256):(uint256,uint256,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new RisqYFIPool__lockedLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBoolean()
      )

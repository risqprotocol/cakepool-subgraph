...
export class RisqGOOGLPool__lockedLiquidityResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
...
export class RisqGOOGLPool extends ethereum.SmartContract {
  static bind(address: Address): RisqGOOGLPool {
    return new RisqGOOGLPool("RisqGOOGLPool", address);
  }
  ...
  lockedLiquidity(param0: BigInt): RisqGOOGLPool__lockedLiquidityResult {
    let result = super.call(
      "lockedLiquidity",
    ...
    return new RisqGOOGLPool__lockedLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBoolean()
    );
  ...
  try_lockedLiquidity(
    param0: BigInt
  ): ethereum.CallResult<RisqGOOGLPool__lockedLiquidityResult> {
    let result = super.tryCall(
      "lockedLiquidity",
      "lockedLiquidity(uint256):(uint256,uint256,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new RisqGOOGLPool__lockedLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBoolean()
      )
